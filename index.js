...
module.exports.validatePasswordStrength = (password) => {
  ...
  if (strongRegex) {
    return { passwordAcceptable: strongRegex, passwordStrength: "strong" };
  } else if (mediumRegex) {
    return { passwordAcceptable: mediumRegex, passwordStrength: "medium" };
  } else return { passwordAcceptable: false, passwordStrength: "weak" };
};
